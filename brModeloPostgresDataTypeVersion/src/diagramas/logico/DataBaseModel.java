...
public class DataBaseModel implements Serializable {
    ...
    private final void InicieAnsi2011() {
        ...
        dataTypesToJava.put("CHAR(15)", "String");
        dataTypesToJava.put("CHAR(20)", "String");
        dataTypesToJava.put("DATE", "Date");
        dataTypesToJava.put("DECIMAL", "double");
        dataTypesToJava.put("DOUBLE PRECISION", "double");
        ...
        dataTypesToJava.put("SERIAL", "int");
        dataTypesToJava.put("TEXT", "String");
        dataTypesToJava.put("TIME", "Date");
        dataTypesToJava.put("TIMESTAMP", "Date");
        dataTypesToJava.put("VARCHAR(150)", "String");
        dataTypesToJava.put("VARCHAR(200)", "String");
    }
